...
Source0  : https://download.gnome.org/sources/gtkmm/3.24/gtkmm-3.24.9.tar.xz
Summary  : C++ binding for the GDK drawing kit, not installed
...
%prep
%setup -q -n gtkmm-3.24.9
cd %{_builddir}/gtkmm-3.24.9
pushd ..
cp -a gtkmm-3.24.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710770533
