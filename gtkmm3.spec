...
Source0  : https://download.gnome.org/sources/gtkmm/3.24/gtkmm-3.24.3.tar.xz
...
%prep
%setup -q -n gtkmm-3.24.3
cd %{_builddir}/gtkmm-3.24.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611167123
...
cp %{_builddir}/gtkmm-3.24.3/COPYING %{buildroot}/usr/share/package-licenses/gtkmm3/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/gtkmm-3.24.3/COPYING.tools %{buildroot}/usr/share/package-licenses/gtkmm3/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
