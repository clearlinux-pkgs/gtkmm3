...
Source0  : https://download.gnome.org/sources/gtkmm/3.24/gtkmm-3.24.5.tar.xz
...
%prep
%setup -q -n gtkmm-3.24.5
cd %{_builddir}/gtkmm-3.24.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621865815
...
cp %{_builddir}/gtkmm-3.24.5/COPYING %{buildroot}/usr/share/package-licenses/gtkmm3/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/gtkmm-3.24.5/COPYING.tools %{buildroot}/usr/share/package-licenses/gtkmm3/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
